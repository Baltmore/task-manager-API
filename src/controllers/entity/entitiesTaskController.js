...
//GET ALL
export const getEntityTask = asyncHandler(async (req, res) => {
  // find all departments in the database
  const consult = await base.findAll(database.entities_tasks);
...
//GET BY ID
export const getEntityTaskById = asyncHandler(async (req, res) => {
...
//POST
export const createEntityTask = asyncHandler(async (req, res) => {
  // get the body from the request
  const body = req.body;

  // create a department in the database
  const created = await base.create(database.entities_tasks, body);
...
//PUT
export const updateEntityTask = asyncHandler(async (req, res) => {
  // get the body from the request
  const query = req.query;
...
//DELETE
export const deleteEntityTask = asyncHandler(async (req, res) => {
  // get the query parameters from the request
  const query = req.query;
