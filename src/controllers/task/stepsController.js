...
export const getStep = asyncHandler(async (req, res) => {
  ...
  const consult = await base.findAll(database.steps);
...
export const getStepById = asyncHandler(async (req, res) => {
  ...
  const consult = await base.findById(database.steps, filter);
...
export const createStep = asyncHandler(async (req, res) => {
  ...
  const created = await base.create(database.steps, body);
...
export const updateStep = asyncHandler(async (req, res) => {
  ...
  const updated = await base.update(database.steps, filter, body);
...
export const deleteStep = asyncHandler(async (req, res) => {
  ...
  const deleted = await base.eliminate(database.steps, filter);
